...
class FragmentFollowers : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.followersfragment, container, false)
    ...
    private fun onGetData(username: String) {
        Retrofit.userRepositories().getUsersFollowers(username).enqueue(object: Callback<List<User>>{
